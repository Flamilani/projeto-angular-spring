package com.example.projetoapi.api.resource;
...
import com.example.projetoapi.api.event.RecursoCriadoEvent;
import com.example.projetoapi.api.exceptionhandler.ProjetoapiExceptionHandler.Erro;
...
import com.example.projetoapi.api.service.LancamentoService;
...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo) {
		Optional<Lancamento> lancamentoEncontrado = lancamentoRepository.findById(codigo);
		 return lancamentoEncontrado.isPresent() ? ResponseEntity.ok(lancamentoEncontrado.get()) : ResponseEntity.notFound().build();
